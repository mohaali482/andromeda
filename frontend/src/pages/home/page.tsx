...
export default function Page() {
    return (
        <div className="flex flex-col-reverse items-center gap-4 mt-8 md:flex-row md:justify-between">
            <div className="bg-accent/65 rounded-lg w-fit h-full text-accent-foreground py-4 px-4">
